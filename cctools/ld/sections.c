...
extern struct merged_segment *merged_segments = NULL;
#ifdef RLD
/*
 ...
 * segments.
 */
extern struct merged_segment *original_merged_segments = NULL;
#endif /* RLD */
 ...
 */
extern enum bool some_non_subsection_via_symbols_objects = FALSE;
